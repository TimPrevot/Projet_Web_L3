        ...
        <div class="my-4 mt-6 -mx-2 lg:flex">
          <div class="lg:px-2 lg:w-1/2">
            <div class="p-4 bg-gray-100 rounded-full">
              <h1 class="ml-2 font-bold uppercase">Code de réduction</h1>
            </div>
            <div class="p-4">
              <p class="mb-4 italic">Si vous avez un code de réduction entrez le dans le champ ci-dessous</p>
              <div class="justify-center md:flex">
                <form action="" method="POST">
                  <div class="flex items-center w-full h-13 pl-3 bg-white bg-gray-100 border rounded-full">
                    ...
                    <button type="submit" class="text-sm flex items-center px-3 py-1 text-white bg-indigo-600 rounded-full outline-none md:px-4 hover:bg-indigo-700 focus:outline-none active:outline-none">
                      ...
                      <span class="font-medium">Appliquer le code</span>
                    </button>
                  </div>
                </form>
              </div>
